...
public class GearsModule implements IModule {
    ...
    private final IForm gearForm = api.newForm(this, "gears", api.itemFormType())
    ...
    public void onCommonSetup(IModuleData moduleData, FMLCommonSetupEvent event) {
        ...
        for (IMaterial material : gearForm.getMaterials()) {
            ...
            ResourceLocation recipeLocation = JAOPCAExtras.rl("gears.from_material." + material.getName());
